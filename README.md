![docker image](https://github.com/CRC270-HoMMage/nomad-oasis/actions/workflows/docker-publish.yml/badge.svg)


# CRC270-HoMMage's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of CRC270-HoMMage.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/CRC270-HoMMage/nomad-oasis.git
    cd nomad-oasis
    ```
    ...
    ```sh
    curl-L -o nomad-oasis.zip "https://github.com/CRC270-HoMMage/nomad-oasis/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/crc270-hommage/nomad-oasis:main` for the services
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/CRC270-HoMMage/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/crc270-hommage/nomad-oasis/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/CRC270-HoMMage/nomad-oasis/manifests/main": unauthorized`
